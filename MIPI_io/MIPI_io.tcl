...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_DATA_LANE0_IO_POSITION {32} \
   CONFIG.C_DATA_LANE1_IO_POSITION {49} \
   CONFIG.C_DATA_LANE2_IO_POSITION {17} \
   CONFIG.C_DATA_LANE3_IO_POSITION {15} \
   CONFIG.C_DPHY_LANES {4} \
   CONFIG.C_EN_BG0_PIN0 {false} \
   CONFIG.C_EN_BG1_PIN0 {true} \
   CONFIG.C_EN_BG3_PIN0 {true} \
   CONFIG.DATA_LANE0_IO_LOC {AJ6} \
   CONFIG.DATA_LANE0_IO_LOC_NAME {IO_L16P_T2U_N6_QBC_AD3P_65} \
   CONFIG.DATA_LANE1_IO_LOC {AE2} \
   CONFIG.DATA_LANE1_IO_LOC_NAME {IO_L24P_T3U_N10_PERSTN1_I2C_SDA_65} \
   CONFIG.DATA_LANE2_IO_LOC {AD7} \
   CONFIG.DATA_LANE2_IO_LOC_NAME {IO_L9P_T1L_N4_AD12P_65} \
   CONFIG.DATA_LANE3_IO_LOC {AG8} \
   CONFIG.DATA_LANE3_IO_LOC_NAME {IO_L8P_T1L_N2_AD5P_65} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRF_APB__DP_VIDEO_REF_CTRL__ACT_FREQMHZ {316.635010} \
