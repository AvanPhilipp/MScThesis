...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set HDMI_in_clk [ create_bd_port -dir I -from 0 -to 0 -type clk HDMI_in_clk ]
  set video_in [ create_bd_port -dir I -from 15 -to 0 video_in ]

  # Create instance: BT656_to_blanking_0, and set properties
  set block_name BT656_to_blanking
  set block_cell_name BT656_to_blanking_0
  if { [catch {set BT656_to_blanking_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $BT656_to_blanking_0 eq "" } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {142.842865} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__DIVISOR0 {7} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__FREQMHZ {148.5} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__SRCSEL {RPLL} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__ACT_FREQMHZ {199.980011} \
  ...
  connect_bd_net -net BT656_to_blanking_0_active_video [get_bd_pins BT656_to_blanking_0/active_video] [get_bd_pins system_ila_0/probe3] [get_bd_pins v_vid_in_axi4s_0/vid_active_video]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets BT656_to_blanking_0_active_video]
  connect_bd_net -net BT656_to_blanking_0_h_blank [get_bd_pins BT656_to_blanking_0/h_blank] [get_bd_pins system_ila_0/probe0] [get_bd_pins v_vid_in_axi4s_0/vid_hblank]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets BT656_to_blanking_0_h_blank]
  connect_bd_net -net BT656_to_blanking_0_v_blank [get_bd_pins BT656_to_blanking_0/v_blank] [get_bd_pins system_ila_0/probe1] [get_bd_pins v_vid_in_axi4s_0/vid_vblank]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets BT656_to_blanking_0_v_blank]
  connect_bd_net -net BT656_to_blanking_0_video_out [get_bd_pins BT656_to_blanking_0/video_out] [get_bd_pins system_ila_0/probe2] [get_bd_pins v_vid_in_axi4s_0/vid_data]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets BT656_to_blanking_0_video_out]
  connect_bd_net -net HDMI_clk [get_bd_pins BT656_to_blanking_0/clk] [get_bd_pins system_ila_0/clk] [get_bd_pins util_ds_buf_0/BUFG_O] [get_bd_pins v_tc_0/clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  connect_bd_net -net HDMI_in_clk_1 [get_bd_ports HDMI_in_clk] [get_bd_pins util_ds_buf_0/BUFG_I]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins v_tc_0/s_axi_aresetn] [get_bd_pins v_vid_in_axi4s_0/aresetn]
  connect_bd_net -net rst_ps8_0_199M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps8_0_199M/peripheral_aresetn]
  connect_bd_net -net video_in_0_1 [get_bd_ports video_in] [get_bd_pins BT656_to_blanking_0/video_in]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins v_vid_in_axi4s_0/vid_io_in_reset] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins v_tc_0/clken] [get_bd_pins v_tc_0/det_clken] [get_bd_pins v_tc_0/resetn] [get_bd_pins v_tc_0/s_axi_aclken] [get_bd_pins v_vid_in_axi4s_0/aclken] [get_bd_pins v_vid_in_axi4s_0/axis_enable] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins v_tc_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk2 [get_bd_pins axi_smc/aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins rst_ps8_0_199M/slowest_sync_clk] [get_bd_pins v_vid_in_axi4s_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk2] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins rst_ps8_0_199M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces axi_vdma_0/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] SEG_zynq_ultra_ps_e_0_HP0_DDR_HIGH
  ...
  exclude_bd_addr_seg [get_bd_addr_segs axi_vdma_0/Data_S2MM/SEG_zynq_ultra_ps_e_0_HP0_PCIE_LOW]
  ...
  exclude_bd_addr_seg [get_bd_addr_segs axi_vdma_0/Data_S2MM/SEG_zynq_ultra_ps_e_0_HP0_QSPI]
